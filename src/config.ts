...
export const themeConfig: ThemeConfig = {
  ...
  color: {
    ...
    light: {
      ...
      primary: 'oklch(0.20 0.005 95)',
      // secondary color
      // used for post text
      secondary: 'oklch(0.38 0.005 95)',
      // accent color
      // used for interaction feedback and restrained emphasis
      accent: 'oklch(0.55 0.18 20)',
      // background color
      background: 'oklch(0.97 0.004 92)',
      // highlight color
      // used for navbar, selected text, etc
      highlight: 'oklch(0.55 0.18 20 / 0.15)',
    },
    dark: {
      // primary color
      primary: 'oklch(0.88 0.003 85)',
      // secondary color
      secondary: 'oklch(0.70 0.003 85)',
      // accent color
      accent: 'oklch(0.50 0.10 20)',
      // background color
      background: 'oklch(0.15 0.008 95)',
      // highlight color
      highlight: 'oklch(0.50 0.10 20 / 0.25)',
    },
  },
  // COLOR SETTINGS >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> END

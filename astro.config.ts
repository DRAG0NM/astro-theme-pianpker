...
import { remarkExternalImages } from './src/plugins/remark-external-images.mjs'
...
const imageConfig = imageHostURL
  ...
  : {}
const analyticsIntegrations = googleAnalyticsID || umamiAnalyticsID
  ? [partytown({
      config: {
